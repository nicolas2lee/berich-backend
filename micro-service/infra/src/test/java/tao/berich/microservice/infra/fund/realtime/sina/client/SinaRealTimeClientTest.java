...
public class SinaRealTimeClientTest {
    private SinaRealTimeClient sinaRealTimeClient;

    @Before
    public void setUp() throws Exception {
        sinaRealTimeClient = new SinaRealTimeClient();
    }
    ...
    public void should_return_fund_detail_when_given_sinajs_response() {
        ...
        final FundDetailDto result = sinaRealTimeClient.mapCsvToFundDetailDto(line);
